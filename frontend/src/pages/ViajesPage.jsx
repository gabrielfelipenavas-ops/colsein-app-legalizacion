...
import { Plus, FileText, DollarSign, Send, Check, X, ArrowLeft, Shield, MapPin, Calendar, Clock, ChevronRight } from 'lucide-react';
import { anticipoAPI } from '../services/api';
import { fmt, dateStr, monthName, PROCESOS, ESTADOS_LABEL, ESTADOS_COLOR } from '../utils/helpers';
  ...
  return (
    <>
      <div className="px-4 flex gap-2 mb-3">
        ...
        <button className="btn-outline flex-1"><FileText size={16} /> Legalizar</button>
      </div>
      ...
      <div className="card mx-4 mt-3">
        ...
        <div className="p-3 bg-slate-50 rounded-xl">
          <p className="text-center text-xs text-slate-400 py-4">Las legalizaciones se habilitarán cuando tengas anticipos aprobados por legalizar.</p>
        </div>
      </div>
